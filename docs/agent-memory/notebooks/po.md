...
- **Still open (separate rows, out of this fix's scope):** A-12/A-04/A-13 debounce (converge row scope item 2 — NOT addressed by the probe.sh guard). E-3 collapse-to-single-row = FIX-SIGNALQUEUE-DUP-ID-GUARD.
