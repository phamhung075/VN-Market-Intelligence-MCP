...
| 1897a | CARRY-FORWARD-c63: task/1872a-5-api-gateway-wording triage — 3 unmerged commits (9f437240 state, 47e745b6 tree-map AC1, 22981c13 mcp-server SSOT). PM/developer decision: merge to main or abandon branch. Blockers: none. Owner: pm + developer. | MEDIUM | TRIAGE | pm | — | — |
...
| 1897c | CARRY-FORWARD-c63: SPIKE—investigate worktree isolation semantics — dev-mcp-server spawned with `isolation: "worktree"` but actual HEAD was checked in main working dir (no separate worktree path created). Result: dev-mainserver-crawls committed e20ebcc1 to spike branch; legitimate work cherry-picked to main as 974a936c. Root cause: Agent tool semantics? Phase 4 not active? Blockers: none. Owner: developer + architect. | MEDIUM | SPIKE | developer | — | — |
