...
|---------|-------|----------|------|-------|-----------|
| SPIKE_006-c61-T1-SHIPPED-c61 | FIX-S **DONE 2026-05-13 c61**: `hitThresholdPct` 0.1→1.0 in `alertOutcomeScorer.ts` price-signal class (both directions). Atomic commit `55085c1c` on `task/spike006-c61-t1-threshold-raise`; merged to main as `d6d3c5d9` (QA Phase 5 GREEN). Tests 9426→9428 (+TEST-15: 0.5%→UNKNOWN, +TEST-16: 1.1%→HIT). Composite class untouched per OOS-2. AC-3 satisfied. T-3 now UNBLOCKED for c62. | HIGH | FIX | developer | 2026-05-13 |
| HEADLOCK-PREFLIGHT-VALIDATED-c61 | OPS-INFO **DONE 2026-05-13 c61**: 12th HEAD.lock recurrence cured at PREFLIGHT 02:36:13Z (age=1940s, size=0). Same PID 51247 (Docker VM) — 5th consecutive cycle with identical fingerprint. F2a Option A shipped c60 — fds expected to carry over 1-3 cycles before drop; H4 surface still active. Evidence: `docs/agent-memory/sessions/preflight-lsof-20260513T023613Z.log`. | INFO | OPS | dev-team | 2026-05-13 |
