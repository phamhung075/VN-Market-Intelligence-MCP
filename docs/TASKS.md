...
| 1899a-domain | SCAFFOLD: Domain layer — models.ts (Article, NewsSource enum, FetchResult), repositories.ts (ReutersNewsPort, BloombergNewsPort interfaces). Zone: apps/news-fetch/. (Tier 2, depends 1899a-core, ~1.5h). | MEDIUM | FEATURE | developer | TASK_1899a-domain.md | — |
