...
| 1941d-fpt-net-profit-ocr-bug | **DONE 2026-05-18 QA** — net_profit_api_bridge column + bridgeNetProfitToFinancialReports() + cashFlowTool COALESCE + ni_source. FPT Q4/2025 OCR=20,225 → bridge=2,509,520 triệu VND, ratio 1.6371 (passes guard). 7 new tests + 17 regression = 24 cashflow tests GREEN, tsc clean, DDD PASS, security PASS. Report: reports/TASK_REPORT_1941d.md. | MEDIUM | FIX | dev-mcp-server | 2026-05-18 |
