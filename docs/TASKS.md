...
| 1937a-cowork-scheduler-mcp-gap | **SPIKE RESOLVED c170** — Root cause found: wrong MCP URL `https://zenmidi.com/mcp` → 404. All cowork agent files and cron files updated to `https://zenmidi.com/vn-market/mcp` via 1938a. CLOSE after next successful scheduled cycle confirms MCP reachable. | MEDIUM | SPIKE | architect | — | — |
