...
- VPS-NEWS-CAFEF-VNECO ✅ 2026-06-01 (814088b0+91bdb305, QA reports/TASK_REPORT_CAFEF-VNECO-QA APPROVED; P1 is_blocked() fix restored cafef+vneconomy feed; P2 /proxy/article-body endpoint deployed on VPS:8765 for cafef.vn+vneconomy.vn; 5000ch/8000ch body text extracted). 🔄 FU-OPS-CAFEF-1 (spot-check ≥2 cycles /var/log/vn-news-fetch.log; confirm cafef-market>0 + cafef-biz>0 zero PERMANENTLY_BLOCKED) · 🔄 FU-OPS-CAFEF-2 (verify pip3 beautifulsoup4 installed; confirm 8k vs 5k active extraction cap) · 🔄 FU-DEV-CAFEF-1 (wire /proxy/article-body into /api/push-news consumer = next sprint candidate)
