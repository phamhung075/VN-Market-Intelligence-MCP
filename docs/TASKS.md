...
| 1899a-routes | **DONE 2026-05-13 c79**: SCAFFOLD: HTTP routes — handlers.ts (Hono router, /health + /news/reuters/headlines + /news/bloomberg/headlines). Zone: apps/news-fetch/. Commits: feat 644c8fe4, nb 43609750. 137/137 pass, tsc 0 errors. QA APPROVED. Unblocks 1899a-gateway. | MEDIUM | FEATURE | developer | TASK_1899a-routes.md | — |
