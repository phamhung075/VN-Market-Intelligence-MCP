# TASK 1508a — RED: cascade-metrics-winrate failing assertions

sprint: 193
phase: RED
test_file: src/__tests__/1508-cascade-metrics-winrate.test.ts

---

## Goal

Write 5 failing assertions that drive GREEN (1508b).
ALL must fail before GREEN starts.
...
- `bun test 1508` → 5 FAIL before 1508b
...
- /Users/admin/Documents/Hung/__works__/__PROJET/__labo/VN-Market-Intelligence-MCP/src/__tests__/1508-cascade-metrics-winrate.test.ts   # created: 5 RED assertions

tests_written:
- src/__tests__/1508-cascade-metrics-winrate.test.ts   # 5 assertions, all RED (FAIL)

tests_skipped: []

tsc_clean: true
full_suite_pass: false   # expected — RED phase, 5 intentional failures
