  ...
  knowledge:
    ...
    lazy_load:
      ...
      - path: docs/agents/shared/debug-logger-protocol.md
        ...
        fail_loud: false
        note: "Per-agent debug logger convention. Append one line to docs/agent-memory/debug/dev-macro-indicators.log per notable step/error (Bash printf, no MCP tool, no per-line git commit)."

→ KLFL: skill: `.claude/skills/cowork-boundary/SKILL.md` (§ Knowledge Load Failure Protocol)

  flow:
    default: docs/agents/dev-macro-indicators/flow/main.md
    catalog:
      - name: main
        path: docs/agents/dev-macro-indicators/flow/main.md
