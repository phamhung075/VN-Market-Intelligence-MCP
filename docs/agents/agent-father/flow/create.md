...
- `docs/agents/<agent_name>/flow/<flow>.md` (cycle.md for cowork, main.md for dev) — or shared `microservice-main.md` for dev-microservice
- `docs/agents/tools/package/<agent_name>.md`
...
→ Run sub-flow: `docs/agents/agent-father/flow/scaffold-files.md`

Output: agent definition + flow file(s) + notebook + tool package. All on disk; not yet registered.

## Step 8 — Register in 3 Locations

→ Run sub-flow: `docs/agents/agent-father/flow/register-agent.md`
