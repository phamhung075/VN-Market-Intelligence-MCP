...
→ KLFL: skill: `.claude/skills/cowork-boundary/SKILL.md` (§ Knowledge Load Failure Protocol)
  ...
  flow:
    default: docs/agents/claude-manager-helper/flow/main.md
    catalog:
      - name: main
        path: docs/agents/claude-manager-helper/flow/main.md
  ...
  tools_package: docs/agents/tools/package/claude-manager-helper.md
