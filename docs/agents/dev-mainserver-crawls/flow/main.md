...
If new technique needed: → run sub-flow: `docs/agents/dev-mainserver-crawls/flow/technique-research.md`
...
Code patterns → `docs/agents/dev-mainserver-crawls/flow/technique-research.md § Code Pattern`

### 4c — Install Dependencies (if new)

Install commands → `docs/agents/dev-mainserver-crawls/flow/technique-research.md § Install Dependencies`
...
RAM profiling command → `docs/agents/dev-mainserver-crawls/flow/technique-research.md § RAM Profiling`
...
```bash
# own_paths: [docs/agent-memory/notebooks/dev-mainserver-crawls.md, docs/mainserver-crawl-techniques/<technique>.md]
...
git commit -m "feat(mainserver-crawls): <source-name> scraper — <technique-name> bypass" \
  -- docs/agent-memory/notebooks/dev-mainserver-crawls.md docs/mainserver-crawl-techniques/<technique>.md
```
