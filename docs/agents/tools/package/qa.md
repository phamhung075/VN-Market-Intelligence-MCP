...
**Location:** `docs/agents/tools/package/qa.md`
...
Flow-level wiring per `docs/agents/qa/flow/main.md` (see also `docs/architecture-briefs/2026-05-21-task-lock-phase3-devteam.md` § 2 + 4.6).
