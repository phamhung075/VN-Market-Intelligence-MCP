...
**Location:** `docs/agents/tools/package/architect.md`
...
Flow-level wiring per `docs/agents/architect/flow/main.md` (see also `docs/architecture-briefs/2026-05-21-task-lock-phase3-devteam.md` § 1 TTL table).
