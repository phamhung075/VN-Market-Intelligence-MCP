...
**Location:** `docs/agents/tools/package/tran-ngoc-bau.md`
...
Complete index → `docs/agents/tools/list/INDEX.md`
...
- **All Tools Index:** `docs/agents/tools/list/INDEX.md`
- **Full Tools List:** `docs/agents/tools/list/all-tools.md`
