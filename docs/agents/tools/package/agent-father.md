...
**Location:** `docs/agents/tools/package/agent-father.md`
...
Flow-level wiring per `docs/agents/agent-father/flow/edit-apply.md` steps 5a/7b/8b (see also `docs/architecture-briefs/2026-05-21-task-lock-phase3-devteam.md` § 2 + 4.8).
...
Grep: "Error Boundary" docs/agents/<agent>/flow/*.md
```
