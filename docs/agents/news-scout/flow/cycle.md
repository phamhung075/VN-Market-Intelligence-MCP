...
**Step 0-GW — Gateway availability gate** → skill: `.claude/skills/gateway-availability-gate/SKILL.md` (PROJECT-ROOT-relative — resolve against repo cwd, NOT `~/.claude/`; see SPIKE-NEWSSCOUT-KLFL-FALSE-ENOENT)
