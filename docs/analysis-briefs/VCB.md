...
| EPS (VND) | 1,033 | N/A (data anomaly in source) | N/A |
| ROE (%) | 16.7% (annualized) | -0.5 pp (quarterly) | N/A |
| Debt/Equity | 0.00x | N/A | N/A |
| Operating Margin (%) | 96.8% | N/A | N/A |
| P/E (x) | 14.1 | sector median: 9.0 (+57% premium) | — |

*QoQ reference is Q1-2025 (earliest period in DB); true Q3→Q4 QoQ unavailable. YoY Q4-2024 not in DB — marked N/A.*
†Primary YoY signal unavailable; verdict defaults to in-line pending DB population.
...
2026-08-11 16:10 | Close: 59.800 VND | RSI: N/A | Vol: N/A | YoY: N/A | Daily: -0.83% | Banking sector pressure (-1.11% avg) amid higher interest rate environment. News mentions ongoing in financial channels. Regime: NEUTRAL. Sentiment: Bearish. Brief action: Hold
