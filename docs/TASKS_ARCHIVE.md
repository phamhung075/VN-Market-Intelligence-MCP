...
|------|---------|--------|---------|
| [sprints-064-077.md](archive/sprints-064-077.md) | 064–077 | 2026-04-12 → 04-14 | Knowledge sync, prediction resolution, Bun.env purge, briefing enrichment, market message review, calibration labels, per-ticker intelligence, BCTC pipeline fix, evening pipeline fix, RSS Atom support, pipeline health tool, pipeline watchdog, TE RSS fallback chain |
