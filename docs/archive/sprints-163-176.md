# Archive — Sprints 163–176

Period: 2026-04-18 → 2026-04-19
Archived from TASKS.md on Sprint 176 completion.

---

## Sprint 176 — fix(sync): bail early on DB corruption in syncVnstockData — COMPLETE

| ID | Title | Status | Role |
|----|-------|--------|------|
| 1466_a | test(sync): TDD RED — 3 failing assertions for DB corruption bail guard | Done | Dev |
| 1466_b | fix(sync): GREEN — add malformed guard + break in syncVnstockData catch block | Done | Dev |

> Report: `reports/TASK_REPORT_1466.md`
...
## Sprint 172 — fix(evening-summary): market_prices freshness guard on watchlistMovers query — COMPLETE
...
## Sprint 171 — fix(checkpoint): RESTART → TRUNCATE + recordJobRun wrapper — COMPLETE
...
## Sprint 170 — fix(schema): move scheduler_locks DDL to schema.ts — COMPLETE
...
## Sprint 169 — fix(evening-summary): watchlistMovers always empty — COMPLETE
...
## Sprint 168 — fix(france-summary): market_prices freshness guard — COMPLETE
...
## Sprint 167 — fix(assembleBriefing): stale market_prices freshness guard — COMPLETE
...
## Sprint 166 — fix(france-summary): market_prices fetched_at → updated_at — COMPLETE
...
## Sprint 165 — feat(france-summary): VN-Index snapshot in morning digest — COMPLETE
...
## Sprint 164 — fix(evening-summary): hasContent ignores vnIndex — COMPLETE
...
## Sprint 163 — fix(checkpoint): PASSIVE → RESTART mode — COMPLETE
