...
## Sprint 1949 Completion — mcp-server Container Restart

**Status:** ✅ DONE — Container restarted, new cron schedules active

**Timestamp:** 2026-05-18 18:43 UTC (Sprint 1949 closed)

**Context:** Sprint 1949 included cron rewiring (commit `44aa791a`). The mcp-server container had been running for 8 hours before restart, predating the commit. Restarted to pick up new job schedules.

### Cron Schedule Changes (Sprint 1949-T6 & T7)

**foreignFlowAlertJob:**
- Old: 09:30 UTC
- New: 08:13 UTC weekdays (`13 8 * * 1-5`)
- Rationale: Aligns with EOD chef reading window at 08:37 UTC (24 min margin)
- Source: `cronConfig.ts` line 66

**macroIndicatorRefreshJob:**
- Old: 06:00 GMT+7 (23:00 UTC previous day)
- New: 19:13 UTC daily (`13 19 * * *`)
- Rationale: 24 min before Evening Preview chef at 19:37 UTC (Sprint 1949-T7)
- Source: `cronConfig.ts` line 104
...
**Verification:**
- Container status: ✅ Healthy (up 5 seconds at check time)
- Scheduler bootstrap: ✅ 70 cron jobs registered
- Job initialization: ✅ Both foreignFlowAlert and macroIndicatorRefresh confirmed loaded
- Log signature: `[scheduler] jobs registered — 70 cron keys in CRONS map`

### Next Events

1. **foreignFlowAlertJob:** First run at 08:13 UTC (weekdays only)
2. **macroIndicatorRefreshJob:** First run at 19:13 UTC (daily)
3. **Chef (unified-agent):** Scheduled Morning Dish at 05:23 UTC tomorrow (user notification sent)
