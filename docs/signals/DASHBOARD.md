...
_Updated: 2026-05-20T21:30Z (dev-mcp-server — 1959-watchdog-5 DONE: disk-usage alert cron registered, cronJobCount 76→77)_
...
| 1959-watchdog-5 | 2026-05-20T21:30Z | dev-mcp-server | task_complete | Disk-usage alert cron DONE. diskUsageAlertJob.ts + cronConfig.ts + startScheduler.ts. Hourly at min=47, BUG on lancedb > 20GB, 6h cooldown. DISK_ALERT_THRESHOLD_GB env override. 9/9 tests GREEN, tsc 0 errors. cronJobCount 76→77. Alert WILL fire immediately post-deploy (lancedb ~29GB). | DONE | docs/signals/dev-mcp-server-1959-watchdog-5.json |
