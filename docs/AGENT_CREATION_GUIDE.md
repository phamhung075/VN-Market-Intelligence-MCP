...
2. `.claude/flows/<agent-id>/cycle.md` — [Section 6.1](guides/guide-flows.md#61-cowork-agent-flow) with lazy-load levels, lesson extraction, registry check
...
2. `.claude/flows/<agent-id>/main.md` — [Section 6.2](guides/guide-flows.md#62-dev-team-agent-flow) with cross-team context, lesson extraction
3. `docs/agent-memory/notebooks/<agent-id>.md` — [Section 7.2](guides/guide-agent-ops.md#72-enhanced-notebook-format-recommended) enhanced format
4. Register ([Section 16](guides/guide-skills-registration.md#16-registration-checklist))
...
2. `.claude/flows/developer/microservice-main.md` — shared flow (exists)
