...
// FIX-VPSHEALTH-DEMANDROUTE-EMPTYQUEUE-MISREPORTS-PROXY-UNREACHABLE: demand-
// driven route queue-depth lookup moved to ./vpsDemandQueue.ts (task
// FIX-CI-SIZELINT-MCPSERVER-SIX-UNCOVERED-OFFENDERS AC-4 — kept this file
// under its size-lint baseline tolerance); re-exported here so existing
// imports of DEMAND_QUEUE_SQL/getDemandQueueDepth from this path are
// unaffected. See vpsDemandQueue.ts for full rationale.
export { DEMAND_QUEUE_SQL, getDemandQueueDepth } from "./vpsDemandQueue.js";
