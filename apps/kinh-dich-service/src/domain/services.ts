...
export const QUE_META: QueMeta[] = [
  { id:  1, name: 'Can',        chinese: '乾', upper: 'Qian', lower: 'Qian' },
  { id:  2, name: 'Khon',       chinese: '坤', upper: 'Kun',  lower: 'Kun'  },
  { id:  3, name: 'Chuan',      chinese: '屯', upper: 'Kan',  lower: 'Zhen' },
  { id:  4, name: 'Mong',       chinese: '蒙', upper: 'Gen',  lower: 'Kan'  },
  { id:  5, name: 'Nhu',        chinese: '需', upper: 'Kan',  lower: 'Qian' },
  { id:  6, name: 'Tung',       chinese: '訟', upper: 'Qian', lower: 'Kan'  },
  { id:  7, name: 'Su',         chinese: '師', upper: 'Kun',  lower: 'Kan'  },
  { id:  8, name: 'Ti',         chinese: '比', upper: 'Kan',  lower: 'Kun'  },
  { id:  9, name: 'Tieu Suc',   chinese: '小畜',upper: 'Xun',  lower: 'Qian' },
  { id: 10, name: 'Lu',         chinese: '履', upper: 'Qian', lower: 'Dui'  },
  { id: 11, name: 'Thai',       chinese: '泰', upper: 'Kun',  lower: 'Qian' },
  { id: 12, name: 'Pi',         chinese: '否', upper: 'Qian', lower: 'Kun'  },
  { id: 13, name: 'Dong Nhan',  chinese: '同人',upper: 'Qian', lower: 'Li'   },
  { id: 14, name: 'Dai Huu',    chinese: '大有',upper: 'Li',   lower: 'Qian' },
  { id: 15, name: 'Khiem',      chinese: '謙', upper: 'Kun',  lower: 'Gen'  },
  { id: 16, name: 'Du',         chinese: '豫', upper: 'Zhen', lower: 'Kun'  },
  { id: 17, name: 'Tuy',        chinese: '隨', upper: 'Dui',  lower: 'Zhen' },
  { id: 18, name: 'Co',         chinese: '蠱', upper: 'Gen',  lower: 'Xun'  },
  { id: 19, name: 'Lam',        chinese: '臨', upper: 'Kun',  lower: 'Dui'  },
  { id: 20, name: 'Quan',       chinese: '觀', upper: 'Xun',  lower: 'Kun'  },
  { id: 21, name: 'Phot He',    chinese: '噬嗑',upper: 'Li',   lower: 'Zhen' },
  { id: 22, name: 'Bi',         chinese: '賁', upper: 'Gen',  lower: 'Li'   },
  { id: 23, name: 'Bat',        chinese: '剝', upper: 'Gen',  lower: 'Kun'  },
  { id: 24, name: 'Phuc',       chinese: '復', upper: 'Kun',  lower: 'Zhen' },
  { id: 25, name: 'Vo Vong',    chinese: '無妄',upper: 'Qian', lower: 'Zhen' },
  { id: 26, name: 'Dai Suc',    chinese: '大畜',upper: 'Gen',  lower: 'Qian' },
  { id: 27, name: 'Di',         chinese: '頤', upper: 'Gen',  lower: 'Zhen' },
  { id: 28, name: 'Dai Qua',    chinese: '大過',upper: 'Dui',  lower: 'Xun'  },
  { id: 29, name: 'Khang',      chinese: '坎', upper: 'Kan',  lower: 'Kan'  },
  { id: 30, name: 'Ly',         chinese: '離', upper: 'Li',   lower: 'Li'   },
  { id: 31, name: 'Ham',        chinese: '咸', upper: 'Dui',  lower: 'Gen'  },
  { id: 32, name: 'Hang',       chinese: '恆', upper: 'Zhen', lower: 'Xun'  },
  { id: 33, name: 'Don',        chinese: '遯', upper: 'Qian', lower: 'Gen'  },
  { id: 34, name: 'Dai Tuong',  chinese: '大壯',upper: 'Zhen', lower: 'Qian' },
  { id: 35, name: 'Tan',        chinese: '晉', upper: 'Li',   lower: 'Kun'  },
  { id: 36, name: 'Minh Di',    chinese: '明夷',upper: 'Kun',  lower: 'Li'   },
  { id: 37, name: 'Gia Nhan',   chinese: '家人',upper: 'Xun',  lower: 'Li'   },
  { id: 38, name: 'Khue',       chinese: '睽', upper: 'Li',   lower: 'Dui'  },
  { id: 39, name: 'Kien',       chinese: '蹇', upper: 'Kan',  lower: 'Gen'  },
  { id: 40, name: 'Giai',       chinese: '解', upper: 'Zhen', lower: 'Kan'  },
  { id: 41, name: 'Ton',        chinese: '損', upper: 'Gen',  lower: 'Dui'  },
  { id: 42, name: 'Ich',        chinese: '益', upper: 'Xun',  lower: 'Zhen' },
  { id: 43, name: 'Quai',       chinese: '夬', upper: 'Dui',  lower: 'Qian' },
  { id: 44, name: 'Cau',        chinese: '姤', upper: 'Qian', lower: 'Xun'  },
  { id: 45, name: 'Tuy',        chinese: '萃', upper: 'Dui',  lower: 'Kun'  },
  { id: 46, name: 'Thang',      chinese: '升', upper: 'Kun',  lower: 'Xun'  },
  { id: 47, name: 'Khon',       chinese: '困', upper: 'Dui',  lower: 'Kan'  },
  { id: 48, name: 'Tinh',       chinese: '井', upper: 'Kan',  lower: 'Xun'  },
  { id: 49, name: 'Cach',       chinese: '革', upper: 'Dui',  lower: 'Li'   },
  { id: 50, name: 'Dinh',       chinese: '鼎', upper: 'Li',   lower: 'Xun'  },
  { id: 51, name: 'Chan',       chinese: '震', upper: 'Zhen', lower: 'Zhen' },
  { id: 52, name: 'Can',        chinese: '艮', upper: 'Gen',  lower: 'Gen'  },
  { id: 53, name: 'Toan',       chinese: '漸', upper: 'Xun',  lower: 'Gen'  },
  { id: 54, name: 'Gui Mei',    chinese: '歸妹',upper: 'Zhen', lower: 'Dui'  },
  { id: 55, name: 'Phong',      chinese: '豐', upper: 'Zhen', lower: 'Li'   },
  { id: 56, name: 'Lu',         chinese: '旅', upper: 'Li',   lower: 'Gen'  },
  { id: 57, name: 'Ton',        chinese: '巽', upper: 'Xun',  lower: 'Xun'  },
  { id: 58, name: 'Doai',       chinese: '兌', upper: 'Dui',  lower: 'Dui'  },
  { id: 59, name: 'Hoan',       chinese: '渙', upper: 'Xun',  lower: 'Kan'  },
  { id: 60, name: 'Tiet',       chinese: '節', upper: 'Kan',  lower: 'Dui'  },
  { id: 61, name: 'Trung Phu',  chinese: '中孚',upper: 'Xun',  lower: 'Dui'  },
  { id: 62, name: 'Tieu Qua',   chinese: '小過',upper: 'Zhen', lower: 'Gen'  },
  { id: 63, name: 'Ky Te',      chinese: '既濟',upper: 'Kan',  lower: 'Li'   },
  { id: 64, name: 'Vi Te',      chinese: '未濟',upper: 'Li',   lower: 'Kan'  },
];
