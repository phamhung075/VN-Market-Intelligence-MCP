 ...
 *  2. ANALYST_NAV has 15 primary analyst tabs, in order, with correct labels + comingSoon flags.
 ...
 *  4. NAV_ITEMS is the union (analyst + system) — 21 total.
...
describe("TopNav — ANALYST_NAV canonical list", () => {
  it("exports exactly 15 analyst nav items", () => {
    expect(ANALYST_NAV).toHaveLength(15);
  });
...
describe("TopNav — NAV_ITEMS union (backward compat)", () => {
  it("NAV_ITEMS is the union of ANALYST_NAV + SYSTEM_NAV (22 items total)", () => {
...
describe("TopNav — rendered output", () => {
  ...
  it("renders all 15 analyst nav labels", () => {
    renderTopNav();
