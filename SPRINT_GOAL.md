...
| 1409d | Create .claude/knowledge/token-economy.md SSOT (3-tier compression policy) | developer | S |
...
- .claude/knowledge/token-economy.md: exists, documents ULTRA/FULL/LITE tiers with usage policy
