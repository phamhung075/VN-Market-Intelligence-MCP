...
**GATEWAY-BLIND guard — SSOT:** `.claude/skills/cycle-bootstrap/SKILL.md` § Error handling (fail-loud)
(FIX-COWORK-SUBAGENT-GATEWAY-BLIND-BOOTSTRAP, 2026-07-07) — CONFIRMED-BLIND/TRANSIENT classification,
retry table, and the Write-fallback-signal + graceful-DEFER protocol all live there. Follow that
section exactly; do not duplicate it here (UC-CCA-P1-GWBLIND-DEDUP).
