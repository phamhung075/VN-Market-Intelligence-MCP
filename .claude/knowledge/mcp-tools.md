...
| BCTC Collector (02) | `get_agent_signals`, `get_market_context`, `get_earnings_calendar`, `get_bctc_full`, `list_stored_pdfs`, `read_bctc_pdf`, `send_telegram`, `get_recent_fixes`, `submit_feedback`, `log_agent_work` |
| Report Analyzer (03) | `get_agent_signals`, `get_market_context`, `get_bctc_full`, `get_financial_summary`, `compare_stocks`, `get_sentiment_trend`, `get_sector_comparison`, `get_kinhdich_reading`, `post_agent_signal`, `get_open_chain_findings`, `get_recent_fixes`, `submit_feedback`, `generate_market_summary`, `get_legal_risk_signals`, `get_insider_signals`, `get_insider_transactions`, `record_evidence_fragment`, `log_agent_work` |
...
| Prediction Synthesizer (08) | `get_watchlist`, `get_evidence_summary`, `get_calibration_report`, `create_prediction_claim`, `get_bctc_full`, `get_market_snapshot`, `log_agent_work`, `get_agent_work_log`, `submit_feedback`, `send_telegram(channel="work")` |
