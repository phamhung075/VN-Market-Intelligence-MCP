...
Mark one specific alert (by ID) or all unread alerts as read. Optionally attach a personal note to a specific alert.
...
const result = await call_tool("vn-market", "mark_alert_read", {
