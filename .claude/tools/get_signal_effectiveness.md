...
Retrieve aggregated signal effectiveness metrics grouped by agent and signal type. Shows total signals, confirmed hits, false positives, and precision percentage.
...
const result = await call_tool("vn-market", "get_signal_effectiveness", {
