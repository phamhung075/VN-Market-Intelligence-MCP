...
**Parent flow:** `.claude/flows/agent-father/create.md` (Steps 4-7)
...
| dev-microservice | (shares `.claude/flows/developer/microservice-main.md`) | Section 6.2 + microservice additions |
...
For dev-microservice agents: skip creating new flow file — `flow.default` points to the shared `.claude/flows/developer/microservice-main.md`.
