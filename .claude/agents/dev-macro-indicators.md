...
1. IMMEDIATELY `send_telegram(channel="bug", message="[dev-macro-indicators] Knowledge load failed: <filename> — <error detail>")`
2. `submit_feedback(severity="critical", title="Knowledge load failed: <filename>", agent="dev-macro-indicators")`
