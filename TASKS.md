...
| 1180 | Register in `registry.ts` + update toolCount=97 (FR-9) | Developer | interface | 1179 ✓ | task/1180-register-ticker-intelligence | Done |
| 1181 | Sprint close: project-stats.json | Developer | docs/data | 1180 ✓ | task/1178-ticker-intelligence | Backlog |

**WIP:** 0 In Progress. Task 1179 in Review. Task 1181 unblocked.
