...
|----|-------|-------|-------|------------|--------|--------|
| 1285 | fix(cooldown): macro_deviation alerts bypass step E cooldown — sent 4x in 1h | Dev | scheduler | — | fix/1285-macro-alert-cooldown | Review |
...
**WIP:** 0 In Progress. 1 Review. Remaining Backlog: 1218, 1248 require VPS SSH access.
