...
| 1112 | @developer | P1 | BCTC VPS proxy: push pattern for geo-blocked PDF fetching. TECH_1112.md. 10 tests. Commit 0ecca9b. Deploy pending: `./deploy-vps-proxy.sh` | Done (code) |
