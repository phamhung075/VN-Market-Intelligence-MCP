...
| 1037 | [janitor] Remove ensureReputationTable() from reputationStore.ts — reputation_scores DDL duplicates schema.ts | code-janitor auto-detected: src/infrastructure/db/reputationStore.ts defines reputation_scores DDL; identical table already created by initDatabase() in schema.ts:286. Remove the local helper and its call sites. | Developer | P3 | — | Backlog |
