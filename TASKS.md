...
| 1003 | FPT/VEA Q4-2025 BCTC overdue 8 days, no PDFs in store. Verify SSC downloader queries FPT/VEA filings page; check if portal HTML changed or filings genuinely not published. Report 998. | `task/1003-ssc-overdue-investigation` | Developer | P2 | — | In Progress |
