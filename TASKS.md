...
| 1005 | Pre-fix phantom alert marker: when a fix ships that invalidates older alerts (e.g. fix 89823e5 for 5.3× volume_spike), tag those alerts as "superseded by fix" so report-analyzer surfaces them with a strikethrough rather than as live CRITICAL. Report 1005. | `task/1005-prefix-alert-marker` | Developer | P3 | — | Backlog |
