...
| 1405b | FIX: bctcQueueEnricherJob catches congbothongtin.ssc.gov.vn/test% placeholder URLs + /api/push-news logVpsPush wrapped in try/catch + vn-news-fetch health probe queries rag_analyses.created_at (not market_messages); 12 new tests | main 2026-04-28 | reports/TASK_REPORT_1405b.md |
