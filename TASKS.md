...
|----|-------|-------|-------|------------|--------|--------|
| 1291 | fix(schema): systematic initDatabase() audit — add missing columns/tables (market_prices_history.exchange, alerts.sent_by, positions, insider_transactions, vnstock_trading_stats) | Dev | infrastructure | — | fix/1291-schema-audit | Review |
| 1292 | fix(kinh-dich): tickerJitter range drift — function returns 0.10/0.115, test asserts max 0.09 | Dev | domain | — | — | Done |
