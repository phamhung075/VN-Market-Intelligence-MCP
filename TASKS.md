...
| 1019 | SSC fetch network timeout not tripping circuit breaker (12:25 UTC 2026-04-07). Investigate why ssc fetcher Network timeout error path bypasses `circuitBreakerRegistry.recordFailure`. Possibly thrown before breaker.execute wrapper. Single occurrence — MONITOR threshold 3 within 24h before action. Report 1015. | `task/1019-ssc-breaker-bypass` | Developer | P3 | — | Backlog |
