...
**WIP:** 0 In Progress. 0 Review. 11 tasks Done (archived). Remaining Backlog requires VPS SSH access: 1218, 1248.

---

## Task Details (active tasks only — Done tasks archived)

*(No active task details — remaining tasks require VPS SSH access for implementation.)*
