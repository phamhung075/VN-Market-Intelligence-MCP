...
| 1007 | Kinh Dich convergence: identical Que Du (16) for VCB/VNM/FPT in same cycle when BCTC absent + small price moves. Add jitter via stock-code hash, OR weight micro-features (open chains, sentiment delta) more aggressively. Report 1007. | `task/1007-kinhdich-convergence` | Developer | P3 | — | Backlog |
...
| 1020 | Kinh Dich identical-result repro confirmed (VCB/VNM/FPT all Que Du 16 same cycle 2026-04-07) — duplicate of 1007 but adds evidence: same -0.30 NguHanh score, same hao pattern. When working 1007, use these three readings as the failing fixture. Report 1014. | `task/1020-kinhdich-evidence` | Developer | P3 | 1007 | Backlog |
